                        ...
                        <div class="card-title mb-4">
                            <div class="d-flex justify-content-start">
                                ...
                                <div class="middle float-right btn-group">
                                    ...
                                    @if(!in_array($userid, $friends) &&  auth()->id() != $userid)
                                        <div class="py-2">
                                            <form action="/addfriend" method="get" >
                                                <input type="hidden" value="{{$userid}}" name="friendid">
                                                <button type="submit" class="btn btn-secondary btn-group" id="btnChangePicture">
                                    ...
                                    @if(in_array($userid, $friends) &&  auth()->id() != $userid)
                                        <div class="py-2 mx-3">
                                            ...
                                            <div class="py-2 mx-3">
                                                <form action="/messageform" method="get" >
                                                    <input type="hidden" value="{{$userid}}" name="addressee">
                                                    <input type="hidden" value="{{auth()->id()}}" name="sender">
                                                    <button type="submit" class="btn btn-secondary btn-group" id="btnChangePicture">
